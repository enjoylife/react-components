...
import {shouldComponentUpdate as scu} from 'react-addons-pure-render-mixin';
...
class Toggle extends React.Component {
  ...
  render () {
    ...
    const checkProp = this.props.hasOwnProperty('checked') ? this.props.checked : defaultChecked;
    const checked = checkProp && !disabled;
